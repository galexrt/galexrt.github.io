...
We use the Iconify service provided by Iconify.Design. Iconify provides a large collection of icons that can be used on websites. When you access a page that uses Iconify icons, your browser will connect to Iconify's servers to download the necessary icon files.
The use of Iconify is based on our legitimate interest in enhancing the visual appeal and user experience of our website.

For more information on Iconify's data privacy policies, please follow this link: [https://iconify.design/privacy/](https://iconify.design/privacy/).
