import{n as e}from"./6qCGA5yR.js";import{n as t}from"./D1nzEUn-.js";import{t as n}from"./Cayr-38q.js";import{C as r,G as i,S as a,k as o,l as s,o as c}from"./kxv79vUE.js";import{t as l}from"./C3WJUzcS2.js";var u=``,d=``,f=``,p=[],m=new Map,h=t(e=>i(e,r()),`sanitizeText`),g=t(e=>{switch(e.type){case`terminal`:return{...e,value:h(e.value)};case`nonterminal`:return{...e,name:h(e.name)};case`sequence`:return{...e,elements:e.elements.map(g)};case`choice`:return{...e,alternatives:e.alternatives.map(g)};case`optional`:return{...e,element:g(e.element)};case`repetition`:return{...e,element:g(e.element),separator:e.separator?g(e.separator):void 0};case`special`:return{...e,text:h(e.text)}}},`sanitizeAstNode`),_=t(()=>{u=``,d=``,f=``,p.length=0,m.clear(),c(),n.debug(`[Railroad] Database cleared`)},`clear`),v=t(e=>{u=h(e),n.debug(`[Railroad] Title set:`,e)},`setTitle`),y=t(()=>u,`getTitle`),b={clear:_,setTitle:v,getTitle:y,addRule:t(e=>{let t={...e,name:h(e.name),definition:g(e.definition),comment:e.comment?h(e.comment):void 0};n.debug(`[Railroad] Adding rule:`,t.name),m.has(t.name)&&n.warn(`[Railroad] Rule '${t.name}' is already defined. Overwriting.`),p.push(t),m.set(t.name,t)},`addRule`),getRules:t(()=>p,`getRules`),getRule:t(e=>m.get(e),`getRule`),setAccTitle:t(e=>{d=h(e).replace(/^\s+/g,``),n.debug(`[Railroad] Accessibility title set:`,e)},`setAccTitle`),getAccTitle:t(()=>d,`getAccTitle`),setAccDescription:t(e=>{f=h(e).replace(/\n\s+/g,`
`),n.debug(`[Railroad] Accessibility description set:`,e)},`setAccDescription`),getAccDescription:t(()=>f,`getAccDescription`),setDiagramTitle:v,getDiagramTitle:y},x={compactMode:!1,padding:10,verticalSeparation:8,horizontalSeparation:10,arcRadius:10,fontSize:14,fontFamily:`monospace`,terminalFill:`#FFFFC0`,terminalStroke:`#000000`,terminalTextColor:`#000000`,nonTerminalFill:`#FFFFFF`,nonTerminalStroke:`#000000`,nonTerminalTextColor:`#000000`,lineColor:`#000000`,strokeWidth:2,markerFill:`#000000`,commentFill:`#E8E8E8`,commentStroke:`#888888`,commentTextColor:`#666666`,specialFill:`#F0E0FF`,specialStroke:`#8800CC`,ruleNameColor:`#000066`,showMarkers:!0,markerRadius:5},S=/^#(?:[\da-f]{3,4}|[\da-f]{6}|[\da-f]{8})$|^(?:rgb|rgba|hsl|hsla|hwb|lab|lch|oklab|oklch)\([\d\s%+,./-]+\)$|^[a-z]+$/i,C=/^[\w "',.-]+$/,w=new Set([`compactMode`,`padding`,`verticalSeparation`,`horizontalSeparation`,`arcRadius`,`fontSize`,`fontFamily`,`terminalFill`,`terminalStroke`,`terminalTextColor`,`nonTerminalFill`,`nonTerminalStroke`,`nonTerminalTextColor`,`lineColor`,`strokeWidth`,`markerFill`,`commentFill`,`commentStroke`,`commentTextColor`,`specialFill`,`specialStroke`,`ruleNameColor`,`showMarkers`,`markerRadius`]),T=t(e=>e?Object.keys(e).every(e=>e===`railroad`||w.has(e)):!1,`isRailroadStyleOptions`),E=t(e=>e?`railroad`in e&&e.railroad?e.railroad:T(e)?e:{}:{},`extractRailroadOverrides`),D=t(e=>{if(!e||T(e))return{};let{railroad:t,svgId:n,theme:r,look:i,...a}=e;return a},`extractThemeOverrides`),O=t((e,t)=>{if(typeof e!=`string`)return t;let n=e.trim();return S.test(n)?n:t},`sanitizeColorValue`),k=t((e,t)=>{if(typeof e!=`string`)return t;let n=e.trim();return C.test(n)?n:t},`sanitizeFontFamilyValue`),A=t((e,t)=>{let n=typeof e==`number`?e:typeof e==`string`?Number.parseFloat(e):NaN;return Number.isFinite(n)&&n>=0?n:t},`sanitizeNumberValue`),j=t(e=>{let t=typeof e==`number`?e:typeof e==`string`?Number.parseFloat(e):NaN;return Number.isFinite(t)&&t>0?t:void 0},`parseThemeFontSize`),M=t(e=>{let t=k(e.fontFamily,x.fontFamily),n=j(e.fontSize)??x.fontSize;return{...x,fontFamily:t,fontSize:n,terminalFill:O(e.secondBkg??e.secondaryColor,x.terminalFill),terminalStroke:O(e.secondaryBorderColor??e.lineColor,x.terminalStroke),terminalTextColor:O(e.secondaryTextColor??e.textColor,x.terminalTextColor),nonTerminalFill:O(e.mainBkg??e.background,x.nonTerminalFill),nonTerminalStroke:O(e.primaryBorderColor??e.lineColor,x.nonTerminalStroke),nonTerminalTextColor:O(e.primaryTextColor??e.textColor,x.nonTerminalTextColor),lineColor:O(e.lineColor,x.lineColor),markerFill:O(e.lineColor,x.markerFill),commentFill:O(e.labelBackground??e.tertiaryColor,x.commentFill),commentStroke:O(e.tertiaryBorderColor??e.lineColor,x.commentStroke),commentTextColor:O(e.tertiaryTextColor??e.textColor,x.commentTextColor),specialFill:O(e.tertiaryColor??e.secondaryColor,x.specialFill),specialStroke:O(e.tertiaryBorderColor??e.secondaryBorderColor,x.specialStroke),ruleNameColor:O(e.titleColor??e.textColor,x.ruleNameColor)}},`buildThemeDefaults`),N=t(e=>{let t=a(),n=M({...o(),...t.themeVariables??{},...D(e)}),r={...t.railroad??{},...E(e)};return{compactMode:r.compactMode??n.compactMode,padding:A(r.padding,n.padding),verticalSeparation:A(r.verticalSeparation,n.verticalSeparation),horizontalSeparation:A(r.horizontalSeparation,n.horizontalSeparation),arcRadius:A(r.arcRadius,n.arcRadius),fontSize:A(r.fontSize,n.fontSize),fontFamily:k(r.fontFamily,n.fontFamily),terminalFill:O(r.terminalFill,n.terminalFill),terminalStroke:O(r.terminalStroke,n.terminalStroke),terminalTextColor:O(r.terminalTextColor,n.terminalTextColor),nonTerminalFill:O(r.nonTerminalFill,n.nonTerminalFill),nonTerminalStroke:O(r.nonTerminalStroke,n.nonTerminalStroke),nonTerminalTextColor:O(r.nonTerminalTextColor,n.nonTerminalTextColor),lineColor:O(r.lineColor,n.lineColor),strokeWidth:A(r.strokeWidth,n.strokeWidth),markerFill:O(r.markerFill,n.markerFill),commentFill:O(r.commentFill,n.commentFill),commentStroke:O(r.commentStroke,n.commentStroke),commentTextColor:O(r.commentTextColor,n.commentTextColor),specialFill:O(r.specialFill,n.specialFill),specialStroke:O(r.specialStroke,n.specialStroke),ruleNameColor:O(r.ruleNameColor,n.ruleNameColor),showMarkers:r.showMarkers??n.showMarkers,markerRadius:A(r.markerRadius,n.markerRadius)}},`buildRailroadStyleOptions`),P=t(e=>{let{fontFamily:t,fontSize:n,terminalFill:r,terminalStroke:i,terminalTextColor:a,nonTerminalFill:o,nonTerminalStroke:s,nonTerminalTextColor:c,lineColor:l,strokeWidth:u,markerFill:d,commentFill:f,commentStroke:p,commentTextColor:m,specialFill:h,specialStroke:g,ruleNameColor:_}=N(e);return`
  .railroad-diagram {
    font-family: ${t};
    font-size: ${n}px;
  }
